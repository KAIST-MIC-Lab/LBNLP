...
\newcommand*{\templateLMRES}{template_LMRES}
% some macros for symbols from Christoph
\input{\templateLMRES/include_symbols/MySymbols_GeneralMath}
\input{\templateLMRES/include_symbols/MySymbols_GeneralDefinitions}
\input{\templateLMRES/include_symbols/MySymbols_Controlsystems}
\input{\templateLMRES/include_symbols/MySymbols_MPC}
\input{\templateLMRES/include_symbols/MySymbols_ThreePhaseSystems}
\input{\templateLMRES/include_symbols/MySymbols_PowerElectronics}
\input{\templateLMRES/include_symbols/MySymbols_ElectricalDrives}

\newcommand{\CHHA}[1]{{\color{red} [CH: #1]}} % Christoph's comment
\newcommand{\KYCH}[1]{{\color{blue} [KC: #1]}} % Kyunghwan's comment
\newcommand{\MSRY}[1]{{\color{magenta} [MS: #1]}} % Myeongseok's comment
...
\begin{figure}[!t]
\centering
\subfigure[]{\includegraphics[width=0.85\linewidth]{figs/Fig_SQP_MTPA}%
\label{Fig_SQP_MTPA}}
\vfill
\subfigure[]{\includegraphics[width=0.85\linewidth]{figs/Fig_SQP_FW}%
\label{Fig_SQP_FW}}
...
\begin{figure}%[!b]
\centering
\subfigure[]{\includegraphics[width=0.85\linewidth]{figs/Fig_ALM_MTPA}%
\label{Fig_ALM_MTPA}}
\vfill
\subfigure[]{\includegraphics[width=0.85\linewidth]{figs/Fig_ALM_FW}%
\label{Fig_ALM_FW}}
...
\begin{figure}[!t]
\centering
\subfigure[]{\includegraphics[width=0.88\linewidth]{figs/Fig_UL1_MTPA}%
\label{Fig_UL1_MTPA}}
\vfill
\subfigure[]{\includegraphics[width=0.88\linewidth]{figs/Fig_UL1_FW}%
\label{Fig_UL1_FW}}
...
\begin{figure}[!t]
\centering
\subfigure[]{\includegraphics[width=0.88\linewidth]{figs/Fig_LBNLP_MTPA}%
\label{Fig_LBNLP_MTPA}}
\vfill
\subfigure[]{\includegraphics[width=0.88\linewidth]{figs/Fig_LBNLP_FW}%
\label{Fig_LBNLP_FW}}
...
% References
\bibliographystyle{\templateLMRES/Bibliography/IEEEtranTIE}
\bibliography{
    \templateLMRES/Bibliography/IEEEabrv,
    \templateLMRES/Bibliography/BIB_xx-TIE-xxxx,
    \templateLMRES/Bibliography/LMRES_Bibliography
